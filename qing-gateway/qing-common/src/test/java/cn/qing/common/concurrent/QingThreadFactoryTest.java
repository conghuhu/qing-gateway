...
public final class QingThreadFactoryTest {
    ...
    private static final String NAME_PREFIX = "qing##thread##";

    @Test
    public void testCreate() {
        ThreadFactory threadFactory = QingThreadFactory.create(NAME_PREFIX, true);
        assertThat(threadFactory, notNullValue());
    }

    @Test
    public void testCustomCreate() {
        ThreadFactory threadFactory = QingThreadFactory.create(NAME_PREFIX, true, 2);
