...
public class MonitorService {
    ...
    public MonitorService(RedisUtil redisUtil, QWebsocketInfoService websocketInfoService) {
    ...
    public List<MonitorInfoVo> getMonitorInfo() {
        ...
        websocketInfoList.forEach(websocketInfo -> {
            String websocketId = websocketInfo.getClientId();
